...
const songs = [{
    ...
    <div class="subtitle">BigBang</div>`,
        ...
        id: 2,
        songName: `Haru Haru <br>
    <div class="subtitle">BigBang</div>`,
        poster: "./img/2.jpg"

    }, {
        id: 3,
        songName: `Bang Bang Bang <br>
    <div class="subtitle">BigBang</div>`,
        poster: "./img/3.jpg"
    ...
    {
        id: 6,
        songName: `Don't fight the feeling<br>
    <div class="subtitle">EXO</div>`,
        poster: "./img/6.jpg"
    ...
    {
        id: 12,
        songName: `Thiên hạ hữu tình nhân<br>
    <div class="subtitle">Chân Thâm/div>`,
        poster: "./img/12.jpg"
    ...
    <div class="subtitle">BlackPinl</div>`,
        poster: "./img/20.jpeg"
    }
]
...
vol.addEventListener('change', () => {
    ...
    if (vol.value > 50) {
        vol_icon.classList.adđ('bi-volume-up-fill');
        vol_icon.classList.remove('bi-volume-down-fill');
        vol_icon.classList.remove('bi-volume-off-fill');
    }
    let vol_a = vol_value;
